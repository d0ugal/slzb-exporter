FROM golang:1.26.4-alpine@sha256:162b257ae1156df92d48e2de5abe69f657fc4961f0ea0e5376837a9ffed8160b AS builder
...
COPY --from=builder --chown=appuser:appuser /app/slzb-exporter .

# Expose port
EXPOSE 9110

# Run the binary
ENTRYPOINT ["./slzb-exporter"]
